...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { aposis: @station.aposis, country_code: @station.country_code, crew_count: @station.crew_count, current_fuel: @station.current_fuel, max_fuel: @station.max_fuel, name: @station.name, peripasis: @station.peripasis } }
